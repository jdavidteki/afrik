      ...
      <div className="HomePage">
        ...
        <div className="HomePage-container">
          <div className="HomePage-greeting" id="homePageGreeting">
            <h1>Welcome! I am Eze, Afrik's Assistant</h1>
          ...
          <div className="HomePage-options">
            ...
            <div className="HomePage-option" onClick={() => location.href = `https://cash.app/$JesuyeDavid/10`}>
            ...
            <div className="HomePage-option" onClick={() => location.href = `https://www.africariyoki.com/karaoke/1nCU_k-VPQo?curtime=201`}>
